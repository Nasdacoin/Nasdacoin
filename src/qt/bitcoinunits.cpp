...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NSD");
    case mBTC: return QString("mNSD");
    case uBTC: return QString::fromUtf8("μNSD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Nasdacoins"));
    case mBTC: return QString(QObject::tr("Milli-Nasdacoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Nasdacoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
